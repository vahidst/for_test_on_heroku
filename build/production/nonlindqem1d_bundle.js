...
var Nonlindqem1d = function (_React$Component) {
    _inherits(Nonlindqem1d, _React$Component);

    // var nonlindq1d=createReactClass({


    function Nonlindqem1d(props) {
        _classCallCheck(this, Nonlindqem1d);

        var _this = _possibleConstructorReturn(this, (Nonlindqem1d.__proto__ || Object.getPrototypeOf(Nonlindqem1d)).call(this, props));
        ...
        _this.set_degree = _this.set_degree.bind(_this);
        _this.set_B_data = _this.set_B_data.bind(_this);
        _this.set_BC_data = _this.set_BC_data.bind(_this);
        _this.send_data_to_solver = _this.send_data_to_solver.bind(_this);

        return _this;
    }

    _createClass(Nonlindqem1d, [{
        key: 'set_degree',
        value: function set_degree(degree) {
            this.setState({
                eq_degree: degree
            });
        ...
        key: 'set_B_data',
        value: function set_B_data(i, text) {
        ...
        key: 'set_BC_data',
        value: function set_BC_data(i, text) {
            // console.log("i="+i+"; and type of i is: "+(typeof i));
            // console.log("text="+text+"; and type of text is: "+(typeof text)); 
        ...
        key: 'send_data_to_solver',
        value: function send_data_to_solver(diff_equation_data) {
        ...
        value: function render() {
            ...
            return React.createElement(
                'div',
                null,
                React.createElement(My_header, null),
                React.createElement('br', null),
                React.createElement(Equation_vu, { get_eq_degree: this.set_degree,
                    get_eq_data: this.send_data_to_solver }),
                React.createElement('br', null),
                React.createElement(BC_vu, { num_of_BC_eq: this.state.eq_degree,
...
ReactDOM.render(React.createElement(Nonlindqem1d, null), document.getElementById("main_entry_point"));

module.exports = Nonlindqem1d;

},{"./public/javascripts/solution_runner":2,"./views/view_components/BC_vu":4,"./views/view_components/equation_vu":5,"./views/view_components/my_header":6,"react":30,"react-dom":27}],2:[function(require,module,exports){
'use strict';

var solution_handler = {

    get_equation_and_post: function get_equation_and_post(eq_data) {
        ...
        xjhr.onreadystatechange = function () {
...
var text_processor = {
    ...
    get_eq_degree: function get_eq_degree(eq) {
...
var BC_eq = function (_React$Component) {
    _inherits(BC_eq, _React$Component);

    function BC_eq(props) {
        _classCallCheck(this, BC_eq);

        var _this = _possibleConstructorReturn(this, (BC_eq.__proto__ || Object.getPrototypeOf(BC_eq)).call(this, props));

        _this.handleChange_B = _this.handleChange_B.bind(_this);
        _this.handleChange_BC = _this.handleChange_BC.bind(_this);
        return _this;
    }

    _createClass(BC_eq, [{
        key: "handleChange_B",
        value: function handleChange_B(e) {
        ...
        key: "handleChange_BC",
        value: function handleChange_BC(e) {
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "span",
                    { className: "Boundary_eq_span" },
                    React.createElement("input", { type: "text", name: "Boundary_eq_text",
                ...
                React.createElement(
                    "span",
                    { className: "Condition_eq_span" },
                    React.createElement("input", { type: "text", name: "Condition_eq_text",
...
var BC_vu = function (_React$Component2) {
    _inherits(BC_vu, _React$Component2);

    function BC_vu(props) {
        _classCallCheck(this, BC_vu);

        var _this2 = _possibleConstructorReturn(this, (BC_vu.__proto__ || Object.getPrototypeOf(BC_vu)).call(this, props));

        _this2.set_B_text = _this2.set_B_text.bind(_this2);
        _this2.set_BC_text = _this2.set_BC_text.bind(_this2);
    ...
    _createClass(BC_vu, [{
        key: "set_B_text",
        value: function set_B_text(i, text) {
            this.props.get_data_from_B(i, text);
        }
    }, {
        key: "set_BC_text",
        value: function set_BC_text(i, text) {
        ...
        value: function render() {
            ...
            var Arr_of_BC_index = Array.apply(null, { length: number_of_BC_equation }).map(Function.call, Number);
            var list_of_BC_eq = Arr_of_BC_index.map(function (index) {
                return React.createElement(BC_eq, { key: (index + 1).toString(),
                    id: "No." + (index + 1),
                    BC_eq_num: index,
                    current_B: _this3.props.pass_B_eqs[index],
                    current_BC: _this3.props.pass_BC_eqs[index],
                    get_state_B: _this3.set_B_text,
                    get_state_BC: _this3.set_BC_text });
            });
...
var equation_vu = function (_React$Component) {
  _inherits(equation_vu, _React$Component);

  function equation_vu(props) {
    _classCallCheck(this, equation_vu);

    var _this = _possibleConstructorReturn(this, (equation_vu.__proto__ || Object.getPrototypeOf(equation_vu)).call(this, props));
    ...
    _this.on_solve = _this.on_solve.bind(_this);
    _this.on_x0_Change = _this.on_x0_Change.bind(_this);
    _this.on_xn_Change = _this.on_xn_Change.bind(_this);
    _this.on_n_Change = _this.on_n_Change.bind(_this);
    return _this;
  }

  _createClass(equation_vu, [{
    key: 'handleChange',
    ...
    key: 'on_x0_Change',
    value: function on_x0_Change(event) {
      this.setState({
    ...
    key: 'on_xn_Change',
    value: function on_xn_Change(event) {
      this.setState({
    ...
    key: 'on_n_Change',
    value: function on_n_Change(event) {
      this.setState({
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        { className: 'diff_eq_inps_div' },
        React.createElement(
          'div',
          { className: 'diff_eq_div' },
          React.createElement(
            'span',
            null,
            React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', { type: 'number', className: 'interval_inp', id: 'xn',
          ...
          React.createElement('input', { type: 'number', className: 'interval_inp', id: 'n',
...
},{"../../public/javascripts/text_processor":3,"react":30}],6:[function(require,module,exports){
"use strict";
...
var my_header = function (_React$Component) {
  _inherits(my_header, _React$Component);

  function my_header() {
    _classCallCheck(this, my_header);

    return _possibleConstructorReturn(this, (my_header.__proto__ || Object.getPrototypeOf(my_header)).apply(this, arguments));
  }

  _createClass(my_header, [{
    key: "render",
    value: function render() {
      return React.createElement(
        "div",
        ...
        React.createElement(
          "h1",
          null,
          " Welcome to NonlinDQEM App "
        ),
        React.createElement(
          "p",
          null,
          " This software tries to solve nonlinear differential equations by differential quadrature finite element method."
        )
      );
    }
  }]);
...
},{"react":30}],7:[function(require,module,exports){
/**
...
},{"./cjs/react.development.js":28,"./cjs/react.production.min.js":29,"_process":22}]},{},[1]);
